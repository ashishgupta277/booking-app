                ...
                <div className="max-w-4xl">
                    <div className="space-y-6">
                        ...
                        <p className="text-xl md:text-2xl text-white/90 font-light max-w-2xl leading-relaxed">
                            Discover amazing hotels and destinations for your perfect vacation. 
                            Search low prices and book with confidence.
                        </p>
                        
                        <div className="flex flex-col sm:flex-row gap-4 pt-4">
                            <button className="bg-gradient-to-r from-white to-emerald-50 text-emerald-700 px-8 py-4 rounded-xl font-semibold text-lg hover:from-emerald-50 hover:to-white transform hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-xl">
                                Start Your Search
                            </button>
                            
                            <button className="bg-white/10 backdrop-blur-sm text-white px-8 py-4 rounded-xl font-semibold text-lg border border-white/20 hover:bg-white/20 transition-all duration-300 hover:scale-105">
                                View Destinations
                            </button>
                        </div>

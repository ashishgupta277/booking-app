...
const Footer = () => {
    return (
        <div className="bg-gradient-to-r from-emerald-600 via-teal-600 to-cyan-600 shadow-lg border-t border-emerald-500">
                ...
                <div className="mt-8 pt-8 border-t border-white/20">
                    <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
                        <p className="text-white/60 text-sm text-center md:text-left">
                            Discover amazing destinations and book your perfect stay with confidence.
                        </p>
